...
export const sortObjectArrByProps: Function = <Type>(objArr: objArr, objProps: prop[] | prop, reverse: string = 's'): Type[] => {
...
const sortIndices: Function = <Type>(objArr: objArr, objProps: prop | prop[], reverse: string = 's') => {
...
const getHighestValue: Function = (objArr: objArr, objProps: prop | prop[]): highestValue => {
...
const increment: Function = (item: value): value => {
...
const greaterString: Function = (text: string): string => {
