export default function sortObjectArrByProps<Type>(                      // 0) Sort Object Arrays By Property takes:
  ...
  let values:string[]|number[]|any[]|string[][]|number[][]|any[][] = []; // will store the values used to sort the list; may sort all values if all properties are informed to 'objProps'
